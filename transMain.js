...
function setUpCamera() {
	...
	glMatrix.mat4.perspective(projMatrix, 0.85, 1.0, 1.0, 300.0);
    ...
    glMatrix.mat4.lookAt(viewMatrix, [5, 7, -10], [0, 0.0, 0], [0, 1, 0]);
...
function drawShapes() {
	...
	// My Code
	// Draw Pedestal
	drawPedestal([0.0, 0.07, 0.0]);
	drawPedestal([3.0, 0.07, 0.0]);
	drawPedestal([-3.0, 0.07, 0.0]);

	// drawCone
	modelMatrix = glMatrix.mat4.create();
	glMatrix.mat4.translate(modelMatrix, modelMatrix, [-3.0, 0.78, 0.0]);
	...
	// draw
	modelMatrix = glMatrix.mat4.create();
	glMatrix.mat4.translate(modelMatrix, modelMatrix, [3.0, 0.75, 0.0]);
	glMatrix.mat4.scale(modelMatrix,modelMatrix, [1.5, 1.5, 1.5])
	gl.uniformMatrix4fv(program.uModelT, false, modelMatrix);
...
function drawPedestal(position) {
	let modelMatrix;
	...
	glMatrix.mat4.scale(modelMatrix, modelMatrix, [1.8, 0.3, 1.8]);
	gl.uniformMatrix4fv(program.uModelT, false, modelMatrix);
	...
	// draw cylinder
	modelMatrix = glMatrix.mat4.create();
	glMatrix.mat4.translate(modelMatrix, modelMatrix, [0.0, -0.8, 0.0]);
	glMatrix.mat4.translate(modelMatrix, modelMatrix, position);
	glMatrix.mat4.scale(modelMatrix, modelMatrix, [1.4, 1.0, 1.4]);
	gl.uniformMatrix4fv(program.uModelT, false, modelMatrix);
